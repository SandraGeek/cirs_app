...
class InfoOutputData {
  /// This class declares all the characteristics found on the information (output) page and and sets their respective values
  ...
  static int calculateScore() {
    /// used to calculate the complexity score of information (output)
  ...
  static void setInfoAustauschFormValue(String value) {
    ...
    if (value == "quasi gleichzeitig") form_des_infoaustausches = 3;
