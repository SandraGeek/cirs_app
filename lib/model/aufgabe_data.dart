...
class AufgabeData {
  ...
  static int calculateScore() {
    ...
    int score = anzMedDomaene + anzPersonen + kommunikation + anzInfokanaele +
        anzInfoentitaeten + prozedur + kontamination +medGeraete + ausbildungsStand + medMaterial;
    return score;
  }
  ...
  static void setkontaminationValue(String value) {
    if (value == "keine Kontaminationsgefahr")
      kontamination = 0;

    if (value == "latente Kontaminationsgefahr")
      kontamination = 1;

    if (value == "manifeste Kontaminationsgefahr")
      kontamination = 2;
  ...
  static void setAusbildungsStandValue(String value) {
    if (value == "PatientIn, Angehörige ")
      ausbildungsStand = 1;

    if (value == "PraktikantIn")
      ausbildungsStand = 1;

    if (value == "StudentIn")
      ausbildungsStand = 2;

    if (value == "GesundheitspflegerIn, MTA, PTA")
      ausbildungsStand = 3;

    if (value == "FachpflegerIn, FachMTA, FachPTA")
      ausbildungsStand = 4;

    if (value == "AssistenzaerztIn")
      ausbildungsStand = 5;

    if (value == "FachaerztIn")
      ausbildungsStand = 6;
  ...
  static void setKommunikationInternValue(String value) {
    if (value == "gleiche hierarchische Ebene")
      kommunikation = 1;

    if (value == "unterschiedliche hierarchische Ebenen")
      kommunikation = 2;

    if (value == "keine Kommunikation")
      kommunikation = 0;
