  ...
  void onPressed() {
    ...
    if (selected != null &&
      ...
      UserData.myScoreData.add(ResQualityData.generateUserDataObjects(
          "Ressourcen",
          ResQualityData.calculateScore(),
          charts.ColorUtil.fromDartColor(Colors.red)));


      UserData.myScoreData.add(ResQualityData.generateUserDataObjects(
        //generates the standard user data object for the resource component. According to the OPT-Model the highest score for resource is 45.
          "Ressourcen",
          45 - ResQualityData.calculateScore(),  // this subtraction is performed to adequately present the remainder of the grey area on the bar chart
          ...
          child: Scrollbar(
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                items: [
                  "strukturierter (aufgeräumter) Arbeitsplatz",
                  "unstrukturierter (unaufgeräumter) Arbeitsplatz",
                  "keine Angaben",
                  "nicht relevant"
                ]
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                // hint: Text("Informationsvolumen"),
                items: [
                  "eindeutiger Name und eindeutiges Aussehen",
                  "sound-alike Medikamente",
                  "look-alike Medikamente",
                  "fehlend",
                  "keine Angaben",
                  "nicht relevant"
                ]
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                // hint: Text("Informationsvolumen"),
                items: [
                  "angemessen und funktionierend",
                  "nicht angemessen, aber funktionierend",
                  "look-alike Geräteteile",
                  "fehlend, funktionslos",
                  "keine Angaben",
                  "nicht relevant"
                ]
                    .map((label) => DropdownMenuItem(
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                // hint: Text("Informationsvolumen"),
                items: [
                  "angemessen, laut akzeptiertem Standard",
                  "nicht angemessen",
                  "look-alike Verbrauchsmaterialien",
                  "fehlend",
                  "keine Angaben",
                  "nicht relevant"
                ]
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                // hint: Text("Informationsvolumen"),
                items: [
                  "kompetenzbewusst, kooperativ",
                  "kompetenzüberschreitend, kooperativ",
                  "kompetenzbewusst, nicht kooperativ",
                  "kompetenzüberschreitend, nicht kooperativ",
                  "keine Angaben",
                  "nicht relevant"
                ]
                    .map((label) => DropdownMenuItem(
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                // hint: Text("Informationsvolumen"),
                items: [
                  "angemessen qualifiziert und ausreichend",
                  "angemessen qualifiziert und nicht ausreichend",
                  "nicht angemessen qualifiziert, aber ausreichend",
                  "nicht angemessen qualifiziert und nicht ausreichend",
                  "keine Angaben",
                  "nicht relevant"
                ]
                    .map((label) => DropdownMenuItem(
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                // hint: Text("Informationsvolumen"),
                items: [
                  "konstant, nicht veränderte Standardbedingung",
                  "veränderte Standardbedingung",
                  "keine Standardbedingung",
                  "keine Angaben",
                  "nicht relevant"
                ]
                    .map((label) => DropdownMenuItem(
